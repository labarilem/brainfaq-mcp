...
test("Bounds Check Left - should measure cells to the left", () => {
  const engine = new BrainfuckEngine();
  // Infinite loop moving left and incrementing cells forever
  const code = "+[<+++++++++++++++++++++++++++++++++.]";
...
test("Bounds Check Left - overflow should trigger error", () => {
